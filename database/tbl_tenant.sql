...
ADD COLUMN ine VARCHAR(255) DEFAULT NULL,
ADD COLUMN comprobante VARCHAR(255) DEFAULT NULL,
ADD COLUMN estado_cuenta VARCHAR(255) DEFAULT NULL,
ADD COLUMN reference_name VARCHAR(100) DEFAULT NULL,
ADD COLUMN reference_phone VARCHAR(20) DEFAULT NULL;